...
class Database:
    """
    مدیریت اتصال دیتابیس و مقداردهی repositoryها برای دسترسی به داده‌ها.
    """
    def __init__(self):
        """
        مقداردهی اولیه Database بدون تنظیمات فوری.
        """
        self.engine = None
        self.Session = None
    ...
    def initialize(self, database_url):
        """
        تنظیمات اولیه دیتابیس و ساخت session factory با استفاده از database_url.
        """
        try:
            if not database_url:
